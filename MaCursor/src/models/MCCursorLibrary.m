...
+ (NSDictionary<NSString *, NSString *> *)undoProperties {
    return @{
        ...
        @"author":     NSLocalizedString(@"author", @"Undo change cursor theme author suffix"),
...
- (BOOL)_readFromDictionary:(NSDictionary *)dictionary {
    ...
    NSString *themeName        = dictionary[MCCursorDictionaryThemeNameKey];
    NSNumber *themeVersion     = dictionary[MCCursorDictionaryThemeVersionKey];
...
- (NSDictionary *)dictionaryRepresentation {
    ...
    drep[MCCursorDictionaryThemeNameKey]       = self.name;
    drep[MCCursorDictionaryThemeVersionKey]    = self.version;
